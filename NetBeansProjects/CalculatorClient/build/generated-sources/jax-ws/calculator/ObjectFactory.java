...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://calculator/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://calculator/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://calculator/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://calculator/", "multiplyResponse");
    private final static QName _DivideResponse_QNAME = new QName("http://calculator/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://calculator/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://calculator/", "multiply");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "multiply")
