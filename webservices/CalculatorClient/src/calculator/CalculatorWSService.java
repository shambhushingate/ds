 ...
 * 
 */
@WebServiceClient(name = "CalculatorWSService", targetNamespace = "http://calculator/", wsdlLocation = "http://localhost:8085/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWSSERVICE_QNAME = new QName("http://calculator/", "CalculatorWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/calculator?wsdl");
